...
import {QueryPickerComponent} from '../../query/query-picker/query-picker.component';
...
import {Restriction} from '../../query/models/Restriction';
import {TermPickerComponent} from '../../coding/term-picker/term-picker.component';
...
export class TestEditorComponent implements OnInit {
  public static open(modalService: NgbModal, test : Test, type : any, restrictions : any) {
    const modalRef = modalService.open(TestEditorComponent, { backdrop : "static", size : "lg"});
  ...
  pickCompareCode(field) {
    ...
    TermPickerComponent.open(this.$modal, vm.codeCompareSelection)
  ...
  showCodePicker() {
    ...
    TermPickerComponent.open(this.$modal, vm.codeSelection)
